...
export function ChatInput({ input, setInput, handleSend, isLoading, className = "", textareaRef, userStatus = 'discover', selectedAgent = 'discover', onAgentChange, userId, conversationId, attachedFiles = [], onFilesChange, onFlashcardClick, onPortfolioClick }: ChatInputProps) {
    ...
    return (
        <div
            className={`relative flex flex-col w-full max-w-5xl mx-auto bg-[#f0e7dd] dark:bg-[#1e1f20] rounded-[24px] p-0 shadow-sm transition-colors ${className}`}
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 w-full">
                ...
                <div className="flex-1 w-full flex items-center">
                    <textarea
                        ...
                        className="w-full bg-transparent border-none focus:outline-none focus:ring-0 resize-none placeholder:text-gray-500 text-gray-900 dark:text-white text-base leading-6 overflow-y-auto max-h-[168px] discret-scrollbar mx-[25px]"
                        style={{
                            minHeight: '24px',
                        }}
                        rows={1}
                ...
                {/* Toolbar Area - Icons on right for desktop, below for mobile */}
                <div className="flex justify-between sm:justify-end items-center w-full sm:w-auto sm:flex-shrink-0">

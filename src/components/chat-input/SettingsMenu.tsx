...
export function SettingsMenu({
  ...
  return (
    <div className="static sm:relative flex-shrink-0">
      <button
        className="flex items-center gap-2 text-gray-900 dark:text-gray-100 hover:bg-gray-200/50 dark:hover:bg-gray-700/50 rounded-full pl-0 pr-3 py-2 transition-colors"
        aria-label="Settings"
        onClick={(e) => {
          e.preventDefault();
          e.stopPropagation();

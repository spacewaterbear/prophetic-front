...
import {AI_COMPANIES, getCompanyFromModelId} from "@/lib/models";
        ...
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button
                    variant="outline"
                    size="sm"
                    className="rounded-full min-w-0 sm:min-w-[180px] justify-between px-2 sm:px-4"
                    disabled={disabled}
                >
              ...
              {currentModel?.name || "Select Model"}
                    ...
                    <ChevronDown className="h-4 w-4 ml-1 sm:ml-2 opacity-50 hidden sm:block"/>
                </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end" className="w-[85vw] sm:w-72 max-w-xs sm:max-w-none">

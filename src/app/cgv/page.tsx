...
const CGV_URL =
  "https://siomjdoyjuuwlpimzaju.supabase.co/storage/v1/object/public/front/legal/CGV_Prophetic_Orchestra_v1.0.md";

export default async function CgvPage() {
  let content = "";
  try {
    const res = await fetch(CGV_URL, { next: { revalidate: 3600 } });
    if (res.ok) {
